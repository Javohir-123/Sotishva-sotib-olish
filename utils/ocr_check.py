...
from config import GOOGLE_CREDENTIALS_PATH, GOOGLE_CREDENTIALS_JSON, CARD_NUMBER
...
def _get_client():
    ...
    if _client is None:
        if GOOGLE_CREDENTIALS_JSON:
            # Railway Variables'ga to'g'ridan-to'g'ri nusxalangan JSON matnidan o'qiladi
            info = json.loads(GOOGLE_CREDENTIALS_JSON)
            _credentials = service_account.Credentials.from_service_account_info(info)
        else:
            # Diskdagi fayldan o'qiladi
